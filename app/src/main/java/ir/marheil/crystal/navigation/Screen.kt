...
enum class AppHub(val title: String, val icon: ImageVector) {
    INVESTMENT("مدیریت سرمایه‌گذاری", Icons.AutoMirrored.Filled.TrendingUp),
...
sealed class Screen(val route: String, val title: String, val icon: ImageVector, val hub: AppHub) {
    ...
    data object Transactions : Screen("invest_transactions", "تراکنش‌ها", Icons.AutoMirrored.Filled.ReceiptLong, AppHub.INVESTMENT)
    ...
    data object Cheques : Screen("life_cheques", "چک‌ها", Icons.AutoMirrored.Filled.FactCheck, AppHub.PERSONAL_LIFE)
